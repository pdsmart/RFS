...
MZB_PATH=${ROOTDIR}/MZB
ROM_PATH=${ROOTDIR}/roms/
...
# Manually choose the programs you want installed into the ROMS. 
# For RFS on the ROMDISK:
#    The files will be first placed into the USER ROM and when full into the Monitor ROM. Thus order is important 
#    if you want a particular program in a particular ROM.
# For RFS on the SFD700:
#    The files will be added onto the end of the SFD700 ROM in order first placed.
#
# NB: A Double Hash (##) indicates a program found not to work on the Sharp MZ-80A.
#
# addMZFToROMImageList <Add to ROMDISK ROMs> <Add to SFD700 ROM> <Reserved 1> <Reserved 2>
#
#
ROM_INCLUDE=""
ROM_INCLUDE_SFD700=""
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/Common/cpm223.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/Common/sharpmz-test.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/Common/testtz.${SECTORSIZE}.bin"
#
# MZ-80A
#
...
# MZ-80K
#
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/3dspacecbasic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/3-d_way_out_bbg_software.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/6502betrmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/6502demo2mc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/6502demomc.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/block_kuzushimc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/bomberbasic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/bomberman_hudson_soft_1983.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/boueisakusenbasic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/boxing_mzmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/breakout_sharp_corporation.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/bugfire_1.1_wics.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/bugfire-newmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/bugfire-oldmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/bugfire_wics.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/daikaisenbasic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/d-day_sharp_corporation.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/defendermc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/defend_the_citybasic.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/fdcontromc.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/gens3_1mc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/gokiburibasic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/goldminebasic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/gomokumc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/hat_the_boxbasic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/home_budget_mk2basic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/hucompilermc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/hucompilmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/identi-kit.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/jampacmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/jintorimc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/jumping_bunnymc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/ladybugmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/laser_commandmc.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/monitormc.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/schlogesmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/scramble.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/scramblemc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/shooting-ufobasic.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_invader2no_intromc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_invader3mc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_invader4mc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space-invadermc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_mouse2mc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_mousemc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_mouse_wics.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_panicmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_ruinerdeffendermc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/space_ruiner_wics_1982.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/wilhelm-tellmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/willhelm_tellmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/yakyukenbasic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/z80assembler2mc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/zardosmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/zardos_mz_soft_group.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/zeichengmc.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-80K/zeroidmc.${SECTORSIZE}.bin"
#
# MZ-700
#
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/breuken_1.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/cadre_diabolique.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/calendrier.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/cannon_ball.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/catacombes.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/comput-a-slot.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/computertekenen.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/connect_four.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/converter_a_700.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/conveyor.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/copy-cf.${SECTORSIZE}.bin"
addMZFToROMImageList 0 1 0 0 "${MZB_PATH}/MZ-700/cosmo_blaster_mz700.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/cribbage.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/croaker.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/cyfax.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/database_filer.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/datei_universal.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/dbp-701.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/delete.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/demasaso.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/demo-lissajou.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/demo_sin-berg.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/fisherman_fred.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/flugsim_mz700.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/flugsimulator.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/fortransosz80.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/full_speed.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/gate-crasher.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/gdp9-ba.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/geboortedatum.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/global_war_3.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/globule.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/gobbler.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/greedy_gremlins.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/grid.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/guerre_spatiale.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/hdc_orgel.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/hp4tmz7.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/hp4tmz7l.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/hunchy.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/impossible_mission.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/isola.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/jeux_intergalactiques.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/jumping_runner.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/jungle-jinks.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/logo_v30.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/mac_pac.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/mad_maze.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/man-hunt.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/manza.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/mastermind.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/math_pendu.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/maze_escape.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/messing.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/mission_a.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/mission_alpha.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/mission_delta.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/ml-sp_8002_bbg.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/moleatta.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/monitor.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/monitor3.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/monitor6.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/morpion.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/morpius.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/moty.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/moving_searcher.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/mucmac700.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/nibbler_part2.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/nightmare_park2.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/nightmare_park.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/nightm_prk.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/nite_flite.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/octopussy.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/pac-man.${SECTORSIZE}.bin"
...
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/space_fighter.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/space_guerilla.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/space_invaders.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/spa_data.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/squash_700.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/star_fighter.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/startrek.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/stkeeper2bas700a.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/strip_poker.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/submarine_shooter.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/sub-monitor-700.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/suicide_run.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/super-bandit.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/super_biorhythm.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/super_helicopter.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/super_puck-man.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/super_spy_obj.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/supertypen.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/super_vrac.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/sutam1f.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/sutamc9.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/sutapeba.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/sutapemo.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/systeme_expert.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/tapeworm.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/tbasic_bm_pk.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/t-basic_(uitleg).${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/telefontarieven.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/three_card_brag.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/tomahawk.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/tracker.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/trans.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/trucker.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/typen.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/ufo.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/uni700basic.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/urania_ii.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/uras-700.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/vicious_viper.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/vol_676.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/vragendmaken.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/wizard_castle.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/wonderhouse.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/wookya.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/wookyb.${SECTORSIZE}.bin"
addMZFToROMImageList 0 0 0 0 "${MZB_PATH}/MZ-700/xanagrams.${SECTORSIZE}.bin"
...
# Add files into the ROMDISK Rom set, incrementing to next ROM when previous is full.
...
# Add files into the SFD700 ROM, discard images when ROM is near full and image wont fit.
IFS=":"; for f in ${ROM_INCLUDE_SFD700}
do
    if [ -f ${f} ]; then
        ...
        if [ ${FILETYPE} == 1 ]; then
            ...
            cat ${SFD700_ROM} "${f}" > /tmp/tmp.size
            FILESIZE=$(stat -c%s "/tmp/tmp.size")
            if (( ${FILESIZE} < 524288 )); then
                echo "Adding $f to SFD700 ROM"
                cat "${f}" >> ${SFD700_ROM}
                basename "${f}" .${SECTORSIZE}.bin >> ${ROM_LIST_FILE}
            else
                echo "Limit reached ROM full, skipping from ${f}..."
                break
            fi
        else
            echo "File:${f},Type:${FILETYPE} is not machine code, skipping.."
